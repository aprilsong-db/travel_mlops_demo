...
git add README.md docs .gitignore travel_mlops_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[travel_mlops_demo/databricks.yml](../travel_mlops_demo/databricks.yml) file. 
...
Follow the instructions in [travel_mlops_demo/resources/README.md](../travel_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../travel_mlops_demo/resources/README.md)  to propose, test, and deploy
